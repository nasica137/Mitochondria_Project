...
#pretrained_model_path = f'./multi_class_hpbandster_not_pretrained/mobilenet_v2_DiceLoss_elastic_(0, 1)/best_model.pth'

#pretrained_model_path = f'./multi_class_cross_validation_not_pretrained/Adam/DiceLoss/Unet_mobilenet_v2/Unet_mobilenet_v2_1000epochs_bs4_lr_0.0001/best_model_fold_1.pth'
...
untreated_pred_pil.save(f'./multi_class_cross_validation/{output_directory}/untreated_predicted_mask.png')
...
plt.tight_layout()
plt.savefig(f'./multi_class_cross_validation/{output_directory}/test_large_untreated_image.png')
...
# Save the PIL image as a PNG file
treated_pred_pil.save(f'./multi_class_cross_validation/{output_directory}/treated_predicted_mask.png')
...
plt.tight_layout()
plt.savefig(f'./multi_class_cross_validation/{output_directory}/test_large_treated_image.png')
...
moving_image2 = sitk.ReadImage(f'./multi_class_cross_validation/{output_directory}/untreated_predicted_mask.png', sitk.sitkFloat32)
...
plt.savefig(f'./multi_class_cross_validation/{output_directory}/test_large_untreated_image_overlay.png')
...
moving_image2 = sitk.ReadImage(f'./multi_class_cross_validation/{output_directory}/treated_predicted_mask.png', sitk.sitkFloat32)
...
plt.axis('off')
plt.title('Fixed Image (Gray) & Ground Truth Overlay (Red - Coolwarm) & Predicted Overlay (Blue - Viridis)')
plt.savefig(f'./multi_class_cross_validation/{output_directory}/test_large_treated_image_overlay.png')