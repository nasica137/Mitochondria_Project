...
model_checkpoint_path = f'./not_pretrained/{output_directory}/best_model.pth'  
...
csv_filename = f'./not_pretrained/{output_directory}/large_image_metrics.csv'
...
pred_pil.save(f'./not_pretrained/{output_directory}/predicted_mask.png')
...
plt.tight_layout()
plt.savefig(f'./not_pretrained/{output_directory}/test_large_image.png')
...
moving_image2 = sitk.ReadImage(f'./not_pretrained/{output_directory}/predicted_mask.png', sitk.sitkFloat32)
...
plt.savefig(f'./not_pretrained/{output_directory}/test_large_image_overlay.png')
