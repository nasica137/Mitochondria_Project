...
test_files = [{"image": img, "mask": mask} for img, mask in zip(images[400:], masks[400:])]
...
# Save as CSV
test_results_df.to_csv(f'./pretrained/{output_directory}/test_logs.csv', index=False)
...
plt.tight_layout()
plt.savefig(f'./pretrained/{output_directory}/multiple_predictions_scores.png')
