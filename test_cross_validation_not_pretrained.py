...
ax.set_title('Multiclass Not Pretrained', fontsize=16)
...
plt.savefig(f'./multi_class_cross_validation_not_pretrained/{output_directory}/stats.png', bbox_inches='tight', pad_inches=0.1)
