...
for augmentation in augmentation_variants:
    ...
    if augmentation in augmentation_mapping:
        ...
        for value in augmentation_values:
            ...
            os.makedirs('multi_class_hpbandster/' + output_directory, exist_ok=True)
            ...
            pretrained_model_path = f'./fine-tuning/{finetuned_directory}/best_model.pth'
            ...
            for i in range(0, epochs):
                ...
                if best_iou_score < valid_logs['iou_score']:
                    ...
                    torch.save(model, f'./multi_class_hpbandster/{output_directory}/best_model.pth')
                    print('Model saved!')
            ...
            train_logs_df.to_csv(f'./multi_class_hpbandster/{output_directory}/train_logs.csv', index=False)
            valid_logs_df.to_csv(f'./multi_class_hpbandster/{output_directory}/valid_logs.csv', index=False)
            ...
            plt.grid()
            plt.savefig(f'./multi_class_hpbandster/{output_directory}/iou_score_plot.png')
            ...
            plt.legend(loc='best', fontsize=16)
            plt.grid()
            plt.savefig(f'./multi_class_hpbandster/{output_directory}/{loss_name}_plot.png')
